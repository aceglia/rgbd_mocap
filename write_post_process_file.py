...
if __name__ == '__main__':
    ...
    data_files = "F:\markerless_project"
        ...
        for f, file in enumerate(files):
            for method in methods:
                for filt in filtered:
                    ...
                    file_path = path + f"{os.sep}marker_pos_multi_proc_3_crops_{method}_{filt}.bio"

                    if not os.path.isfile(file_path):
                        print(f"file {file} not processed for participant {part}")
                        continue
                    data = load(file_path, merge=True)
                    ...
                    #     final_end_idx = 7200
                    # elif part == "P10" and "gear_10" in file:
                    #     final_end_idx = 8550
                    ...
                    # plt.show()
                    save(data, path + os.sep + f"marker_pos_multi_proc_3_crops_{method}_{filt}_pp.bio", safe=False)
                    print(f"file {file} processed for participant {part}")