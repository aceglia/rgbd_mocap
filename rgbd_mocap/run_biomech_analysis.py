...
def main(
    ...
    for part, file in zip(mapped_part, all_files):
        ...
        output_file = (
            prefix
            + f"/Projet_hand_bike_markerless/process_data/{part}/result_biomech_{trial_short}_with_technical_marker_final_optim_param.bio"
        )
        ...
        for key in markers_dic.keys():
            ...
            biomech_pipeline.stop_frame = min(biomech_pipeline.stop_frame, markers_dic[key][1].shape[2])
            # if part == "P10" and 'gear_5' in file:
            #     biomech_pipeline.stop_frame = 13000
