...
from Video_editing.video_edit_linker import VideoEditLinker
...
if __name__ == '__main__':
    ...
    frame_color = cv2.cvtColor(cv2.imread(path + 'color_600.png'), cv2.COLOR_BGR2RGB)
    frame_depth = cv2.imread(path + 'depth_600.png', cv2.IMREAD_ANYDEPTH)
