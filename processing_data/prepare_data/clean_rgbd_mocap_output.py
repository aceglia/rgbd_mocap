...
if __name__ == "__main__":
    ...
    trials = ["gear_20", "gear_10", "gear_15", "gear_20"]

    data_files = f"{prefix}/Projet_hand_bike_markerless/RGBD"
    files, parts = get_all_file(participants, data_files, trial_names=trials, to_include=["gear"], to_exclude=["result"], is_dir=True)
